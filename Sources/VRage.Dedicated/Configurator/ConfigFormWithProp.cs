...
{
    public partial class ConfigFormWithProp<T> : Form where T : MyObjectBuilder_SessionSettings, new()
    {
        ...
        public ConfigFormWithProp(bool isService, string serviceName)
        {
        ...
        private void ConfigFormWithProp_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox_SaveGames_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox_SaveGames.SelectedIndex != -1)
            {
                ulong sizeInBytes;

                WorldItem worldItem = (WorldItem)comboBox_SaveGames.Items[comboBox_SaveGames.SelectedIndex];
